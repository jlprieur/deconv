...
*
	...
	real*4	fradius,alphat,Nor_phi_T
...
*
	...
	call jlp_inquifmt
        write(6,102)
102     format('******* Program d_lissage  Version 27-03-99')
*
...
*
	call lisse(fradius,npix(1),npix(2),madrid(pntrhr),
...
*
*-------------------------------------------------------------------------------
 	subroutine lisse(fradius,nx,ny,sectr,elipr,
     1	stock,tempr,tempi,dptempr,dptempi,lu)
	implicit none
*
	integer*4 nx,ny,dptempr, dptempi,lu
	real*4 sectr (nx,*),elipr (nx,*),fradius,Gain
	...
	integer*4 N2,ixcenter,iycenter,n_sur_2,k1,l1
 	...
 	real*4 test_real,x,A,eta0,pi,rr,Rp
...
1005	format (' Radius of Hr (Fourier space)  : ',F6.3)
	write (lu, '(a)') ' '
*
...
* dpntR : Pointeur de la partie reelle	    de phi_T		entier
* dpntI :	"	"       imaginaire     "		entier
...
*
	...
	integer*4 n,pntr,i,npix(2),madrid(1)
	common /vmr/madrid
*
	do i=1,n
